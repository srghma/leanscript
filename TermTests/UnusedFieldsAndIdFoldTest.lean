...
/--
info: Term.atom (Atom.lam (Term.atom (Atom.nat_mk 7)) ⋯)
-/
#guard_msgs in
...
/--
info: Term.atom (Atom.lam (Term.atom (Atom.nat_mk 3)) ⋯)
-/
#guard_msgs in
...
/--
info: Term.atom (Atom.lam (Term.atom (Atom.nat_mk 5)) ⋯)
-/
#guard_msgs in
...
info: Term.atom
  (Atom.lam
    (Term.atom
      (Atom.lam
        (Term.comp
          (Comp.externCall (Spine.cons (Atom.ref (Ref.var DeBruijnProj.head)) (Spine.cons (Atom.nat_mk 1) Spine.nil))
            (fun vs => LeanInitPureExtern.preludeExtern (PreludeExtern.lean_nat_add vs.1 vs.2.1)) ⋯ ⋯)
          deadField_term._proof_4)
        ⋯))
    ⋯)
-/
#guard_msgs in
