...
#guard_msgs (error) in
example : Term sig0 [] 0 (TyWf.prim .nat ⇒ TyWf.prim .nat) .UNKNOWN :=
...
#guard_msgs (error) in
example : Term sig0 [] 0 (TyWf.prim .nat ⇒ TyWf.prim .nat) .UNKNOWN := #leanscript_to_term loop
...
#guard_msgs (error) in
example : Term sig0 [] 0 (TyWf.prim .nat ⇒ TyWf.prim .nat) .UNKNOWN := #leanscript_to_term unsafeId
...
#guard_msgs (error) in
example : Term sig0 [] 0 (TyWf.prim .nat ⇒ TyWf.prim .nat) .UNKNOWN := #leanscript_to_term halve
...
#guard_msgs (error) in
example : Term sig0 [] 0 (TyWf.prim .nat ⇒ tyWfOf (Option Nat)) .UNKNOWN := #leanscript_to_term spin
...
example : Term sig0 [] 0 (TyWf.prim .nat) .UNKNOWN := #leanscript_to_term stuck
