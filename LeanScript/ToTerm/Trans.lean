...
public meta import LeanScript.ToTerm.TransCtor
...
those for constructor applications in `LeanScript.ToTerm.TransCtor`, and are passed `trans`
as an argument.  The elaborator that calls it is
...
partial def transConstApp (c : TCtx) (e : Expr) (n : Name) (lvls : List Level)
  ...
  | some (.ctorInfo ci) => return ← transCtorApp trans transCheck c e ci args
