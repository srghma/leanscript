...
inductive LeanInitPureExternLazy : LeanPrimTy → Type where
  | lean_version_get_special_desc          : LeanInitPureExternLazy .string -- always "leanscript"
  | lean_version_get_is_release            : LeanInitPureExternLazy .bool -- always false
  | lean_version_get_major                 : LeanInitPureExternLazy .nat -- always 0
  | lean_version_get_patch                 : LeanInitPureExternLazy .nat -- always 0
  | lean_internal_is_stage0                : LeanInitPureExternLazy .bool -- always false
  | lean_version_get_minor                 : LeanInitPureExternLazy .nat -- always 0
  | lean_get_githash                       : LeanInitPureExternLazy .string -- always "leanscript"
  | lean_internal_has_llvm_backend         : LeanInitPureExternLazy .bool -- always false
  | lean_system_platform_emscripten        : LeanInitPureExternLazy .bool -- always false
  | lean_system_platform_target            : LeanInitPureExternLazy .string -- always "nodeorbrowser"
  -- can:
  ...
  -- (‡) | lean_system_platform_linux             : LeanInitPureExternLazy .bool -- no support bc IO
  -- (‡) | lean_internal_get_hardware_concurrency : LeanInitPureExternLazy .uint32 -- always 0
...
inductive LeanInitPureExtern1OnlyPrim : LeanPrimTy → LeanPrimTy → Type where
  ...
  | lean_usize_of_nat_lt            : LeanInitPureExtern1OnlyPrim nat LeanPrimTy.usize
  ...
  | lean_usize_of_nat_mk            : LeanInitPureExtern1OnlyPrim (bitvec 64) LeanPrimTy.usize
  | lean_usize_to_bitvec            : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize (bitvec 64)
  ...
  | lean_usize_to_nat               : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize nat
  ...
  | lean_usize_of_nat               : LeanInitPureExtern1OnlyPrim nat LeanPrimTy.usize
  ...
  | lean_string_of_usize            : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize string
  | lean_nat_log2                   : LeanInitPureExtern1OnlyPrim nat nat
  | lean_uint16_neg                 : LeanInitPureExtern1OnlyPrim uint16 uint16
  | lean_uint16_to_usize            : LeanInitPureExtern1OnlyPrim uint16 LeanPrimTy.usize
  ...
  | lean_usize_neg                  : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize LeanPrimTy.usize
  | lean_usize_to_uint64            : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize uint64
  | lean_bool_to_uint64             : LeanInitPureExtern1OnlyPrim bool uint64
  | lean_usize_of_nat32             : LeanInitPureExtern1OnlyPrim nat LeanPrimTy.usize
  | lean_uint64_neg                 : LeanInitPureExtern1OnlyPrim uint64 uint64
  | lean_uint32_to_usize            : LeanInitPureExtern1OnlyPrim uint32 LeanPrimTy.usize
  | lean_uint8_complement           : LeanInitPureExtern1OnlyPrim uint8 uint8
  | lean_usize_to_uint16            : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize uint16
  | lean_usize_to_uint8             : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize uint8
  ...
  | lean_uint8_to_usize             : LeanInitPureExtern1OnlyPrim uint8 LeanPrimTy.usize
  | lean_bool_to_uint16             : LeanInitPureExtern1OnlyPrim bool uint16
  | lean_bool_to_usize              : LeanInitPureExtern1OnlyPrim bool LeanPrimTy.usize
  | lean_uint64_to_usize            : LeanInitPureExtern1OnlyPrim uint64 LeanPrimTy.usize
  | lean_usize_to_uint32            : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize uint32
  | lean_usize_complement           : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize LeanPrimTy.usize
  -- (†) | lean_byte_array_hash            : LeanInitPureExtern1OnlyPrim byteArray uint64
  -- (†) | lean_sarray_size                : LeanInitPureExtern1OnlyPrim byteArray LeanPrimTy.usize
  ...
  | lean_isize_complement           : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize LeanPrimTy.isize
  | lean_int16_of_nat               : LeanInitPureExtern1OnlyPrim nat int16
  | lean_int32_of_int               : LeanInitPureExtern1OnlyPrim int int32
  | lean_int64_to_isize             : LeanInitPureExtern1OnlyPrim int64 LeanPrimTy.isize
  | lean_isize_to_int8              : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize int8
  ...
  | lean_int32_to_isize             : LeanInitPureExtern1OnlyPrim int32 LeanPrimTy.isize
  ...
  | lean_isize_to_int16             : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize int16
  ...
  | lean_isize_of_int               : LeanInitPureExtern1OnlyPrim int LeanPrimTy.isize
  | lean_int16_abs                  : LeanInitPureExtern1OnlyPrim int16 int16
  | lean_int16_to_int32             : LeanInitPureExtern1OnlyPrim int16 int32
  | lean_isize_to_int               : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize int
  | lean_isize_of_nat               : LeanInitPureExtern1OnlyPrim nat LeanPrimTy.isize
  | lean_int16_complement           : LeanInitPureExtern1OnlyPrim int16 int16
  | lean_isize_to_int64             : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize int64
  | lean_int64_complement           : LeanInitPureExtern1OnlyPrim int64 int64
  | lean_isize_abs                  : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize LeanPrimTy.isize
  | lean_int16_of_int               : LeanInitPureExtern1OnlyPrim int int16
  | lean_int8_neg                   : LeanInitPureExtern1OnlyPrim int8 int8
  | lean_isize_to_int32             : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize int32
  ...
  | lean_bool_to_isize              : LeanInitPureExtern1OnlyPrim bool LeanPrimTy.isize
  ...
  | lean_isize_neg                  : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize LeanPrimTy.isize
  ...
  | lean_int8_to_isize              : LeanInitPureExtern1OnlyPrim int8 LeanPrimTy.isize
  ...
  | lean_int16_to_isize             : LeanInitPureExtern1OnlyPrim int16 LeanPrimTy.isize
  ...
  | lean_usize_to_float             : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize float
  ...
  | lean_float_to_usize             : LeanInitPureExtern1OnlyPrim float LeanPrimTy.usize
  ...
  -- (†) | lean_float_array_usize          : LeanInitPureExtern1OnlyPrim floatArray LeanPrimTy.usize
  -- (†) | lean_float_array_size           : LeanInitPureExtern1OnlyPrim floatArray nat
  | lean_usize_log2                 : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize LeanPrimTy.usize
  ...
  | lean_isize_to_float             : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize float
  ...
  | lean_float_to_isize             : LeanInitPureExtern1OnlyPrim float LeanPrimTy.isize
  ...
  | lean_usize_to_float32           : LeanInitPureExtern1OnlyPrim LeanPrimTy.usize float32
  ...
  | lean_float32_to_usize           : LeanInitPureExtern1OnlyPrim float32 LeanPrimTy.usize
  ...
  | lean_float32_to_isize           : LeanInitPureExtern1OnlyPrim float32 LeanPrimTy.isize
  ...
  | lean_isize_to_float32           : LeanInitPureExtern1OnlyPrim LeanPrimTy.isize float32
...
inductive LeanInitPureExtern2OnlyPrim : LeanPrimTy → LeanPrimTy → LeanPrimTy → Type where
  ...
  | lean_usize_dec_eq             : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize bool
  ...
  | lean_usize_add                : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  | lean_uint32_sub               : LeanInitPureExtern2OnlyPrim uint32 uint32 uint32
  | lean_usize_sub                : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  | lean_uint32_add               : LeanInitPureExtern2OnlyPrim uint32 uint32 uint32
  | lean_usize_dec_le             : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize bool
  | lean_usize_dec_lt             : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize bool
  ...
  | lean_usize_land               : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  | lean_usize_mul                : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  | lean_uint64_shift_right       : LeanInitPureExtern2OnlyPrim uint64 uint64 uint64
  | lean_usize_shift_left         : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  | lean_uint16_add               : LeanInitPureExtern2OnlyPrim uint16 uint16 uint16
  | lean_usize_xor                : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  ...
  | lean_usize_lor                : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  ...
  | lean_usize_shift_right        : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  ...
  | lean_usize_div                : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  ...
  | lean_usize_mod                : LeanInitPureExtern2OnlyPrim LeanPrimTy.usize LeanPrimTy.usize LeanPrimTy.usize
  ...
  -- (†) | lean_byte_array_uget          : LeanInitPureExtern2OnlyPrim byteArray LeanPrimTy.usize uint8
  -- (†) | lean_byte_array_get           : LeanInitPureExtern2OnlyPrim byteArray nat uint8
  -- | lean_string_get_utf8_byte     : LeanInitPureExtern2OnlyPrim string stringPos uint8 -- TODO: no such func?
  ...
  -- | lean_string_utf8_get_fast     : LeanInitPureExtern2OnlyPrim string nat char -- TODO: dependent function, needs special treatment. Use Slice.Pos.get instead of decodeChar?
  ...
  | lean_isize_xor                : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  | lean_isize_shift_left         : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  ...
  | lean_isize_mod                : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  | lean_int8_mod                 : LeanInitPureExtern2OnlyPrim int8 int8 int8
  | lean_isize_shift_right        : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  ...
  | lean_isize_div                : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  | lean_int16_dec_eq             : LeanInitPureExtern2OnlyPrim int16 int16 bool
  | lean_isize_add                : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  | lean_int32_dec_lt             : LeanInitPureExtern2OnlyPrim int32 int32 bool
  | lean_isize_lor                : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  ...
  | lean_isize_land               : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  | lean_isize_mul                : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  | lean_int64_dec_lt             : LeanInitPureExtern2OnlyPrim int64 int64 bool
  | lean_isize_dec_le             : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize bool
  ...
  | lean_isize_sub                : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize LeanPrimTy.isize
  ...
  | lean_isize_dec_lt             : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize bool
  ...
  | lean_isize_dec_eq             : LeanInitPureExtern2OnlyPrim LeanPrimTy.isize LeanPrimTy.isize bool
  ...
  -- (†) | lean_float_array_uget         : LeanInitPureExtern2OnlyPrim floatArray LeanPrimTy.usize float
  ...
  | lean_float32_scaleb           : LeanInitPureExtern2OnlyPrim float32 int64 float32 -- TODO: wrong type, should be int
  ...
  | lean_string_uget_byte_fast    : LeanInitPureExtern2OnlyPrim string LeanPrimTy.usize uint8
...
inductive LeanInitPureExtern1 : X → X → Type where
  ...
  | lean_panic_fn_borrowed         : (α : X) → (c : Inhabited X) → LeanInitPureExtern1 string α
  ...
  | lean_ptr_addr                  : (α : X) → LeanInitPureExtern1 α LeanPrimTy.usize
  ...
  | lean_array_size                : (α : X) → LeanInitPureExtern1 (array α) LeanPrimTy.usize
  | lean_io_promise_result_opt     : (α : X) → LeanInitPureExtern1 (promise α) (task (option α))
  | lean_option_get_or_block       : (α : X) → (c : Nonempty X) → LeanInitPureExtern1 (option α) α
...
inductive LeanInitPureExtern2 : X → X → X → Type where
  | lean_array_get_borrowed     : (α : X) → (c : Inhabited X) → LeanInitPureExtern2 (array α) nat α
  | lean_array_push             : (α : X) → LeanInitPureExtern2 (array α) α (array α)
  | lean_array_fget_borrowed    : (α : X) → LeanInitPureExtern2 (array α) nat α
  | lean_array_get              : (α : X) → (c : Inhabited X) → LeanInitPureExtern2 (array α) nat α
  ...
  | lean_array_uget             : (α : X) → LeanInitPureExtern2 (array α) LeanPrimTy.usize α
  ...
  | lean_array_uget_borrowed    : (α : X) → LeanInitPureExtern2 (array α) LeanPrimTy.usize α
...
inductive LeanInitPureExtern3 : X → X → X → X → Type where
  ...
  | lean_array_uset       : (α : X) → LeanInitPureExtern3 (array α) LeanPrimTy.usize α (array α)
  ...
  | lean_byte_array_uset           : LeanInitPureExtern3 byteArray LeanPrimTy.usize uint8 byteArray
  ...
  | lean_float_array_uset          : LeanInitPureExtern3 floatArray LeanPrimTy.usize float floatArray
