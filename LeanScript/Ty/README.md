...
`LeanScript/Expr.lean` are consumers, and `LeanScript/LeanPrimTy.lean` and
`LeanScript/LeanPrimTyCovariant.lean` are the leaf types, which say nothing about
recursion and are shared with the backends.
