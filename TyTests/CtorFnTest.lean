...
`TyTests.InductiveTypesTest.Existentials` — together with the cache and the refusals.
-/
...
`TyTests.CtorFnTest.Module` generated `Option.some` (and so `Option`'s layout); here it is
...
/--
info: def CtorFnTest.some4 : Term sig [] (TyTests.CtorFnTest.Module.Option.leanScriptLayout natT) :=
TyTests.CtorFnTest.Module.Option.some.leanScriptCtor natT (Term.nat_mk 4)
-/
...
-- The cache: what this file and `TyTests.CtorFnTest.Module` generated, which a module
...
layout of Option: TyTests.CtorFnTest.Module.Option.leanScriptLayout
fn of Option.some: TyTests.CtorFnTest.Module.Option.some.leanScriptCtor
fn of Option.none: TyTests.CtorFnTest.Option.none.leanScriptCtor
layout of Prod: TyTests.CtorFnTest.Prod.leanScriptLayout
fn of Prod.mk: TyTests.CtorFnTest.Prod.mk.leanScriptCtor
layout of Sum: TyTests.CtorFnTest.Sum.leanScriptLayout
fn of Sum.inr: TyTests.CtorFnTest.Sum.inr.leanScriptCtor
layout of Bool: TyTests.CtorFnTest.Bool.leanScriptLayout
fn of Bool.true: TyTests.CtorFnTest.Bool.true.leanScriptCtor
layout of Ordering: TyTests.CtorFnTest.Ordering.leanScriptLayout
fn of Ordering.gt: TyTests.CtorFnTest.Ordering.gt.leanScriptCtor
layout of List: TyTests.CtorFnTest.List.leanScriptLayout
fn of List.cons: TyTests.CtorFnTest.List.cons.leanScriptCtor
fn of List.nil: TyTests.CtorFnTest.List.nil.leanScriptCtor
